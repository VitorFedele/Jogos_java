...
public class JTelinhas extends JFrame {
    ...
    this.resetBut.setLocation(1700,80 );
...
this.facilButton.setLocation(1700,300);
...
this.medButton.setLocation(1800,300);
...
this.hardbuton.setLocation(1700,400);
...
this.cusButton.addActionListener((java.awt.event.ActionEvent evt) ->{
 ...
 int l = Integer.parseInt(JOptionPane.showInputDialog("insira 'linha, linha não pode ser maior que 38'"));
C.NUM_LINHAS = l;
 int c = Integer.parseInt(JOptionPane.showInputDialog("insira 'coluna, colunha não pode ser maior que 25'"));
C.NUM_COLUNAS = c;
...
this.cusButton.setLocation(1800,400);
